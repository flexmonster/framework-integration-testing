describe("testing page With amCharts", () => {
  ...
  it("Check 'Integration with amCharts' link to docs", (client) => {
    ...
    this.pivotContainer.section.description.expect.element("@toAMChartsIntegrationLink").to.be.visible;
    this.pivotContainer.section.description.expect.element("@toAMChartsIntegrationLink").text.to.be.equal("Integration with amCharts");
    this.pivotContainer.section.description.expect
      .element("@toAMChartsIntegrationLink")
