describe("testing using API calls page", () => {
  ...
  it("Check Using API calls link to docs", () => {
    this.pivotContainer.section.description.expect.element("@linkToAPICalls").to.be.visible;
    this.pivotContainer.section.description.expect.element("@linkToAPICalls").text.to.be.equal("API calls");
    this.pivotContainer.section.description.expect
      .element("@linkToAPICalls")
  ...
  it("Check Using API calls view toggle(column chart)", () => {
    browser.waitForElementPresent(this.pivotContainer.section.grid, 3000);
    ...
    this.pivotContainer.section.viewToggle.expect.element("@viewCheckbox").to.not.be.selected;
    this.pivotContainer.section.viewToggle.expect.element("@viewCheckboxLabel").text.to.be.equal("Column chart");
    this.pivotContainer.section.viewToggle.assert.cssProperty("@viewCheckboxLabel", "background-color", "rgba(223, 56, 0, 1)");
  ...
  it("Check Using API calls view toggle(grid)", () => {
    ...
    this.pivotContainer.section.viewToggle.click("@viewCheckboxLabel");
    this.pivotContainer.section.viewToggle.expect.element("@viewCheckbox").to.be.selected;
    this.pivotContainer.section.viewToggle.expect.element("@viewCheckboxLabel").text.to.be.equal("Grid");
    this.pivotContainer.section.viewToggle.assert.cssProperty("@viewCheckboxLabel", "background-color", "rgba(0, 164, 90, 1)");
  ...
  it("Check Using API calls mode toggle(read-only)", (client) => {
    ...
    this.pivotContainer.section.modeToggle.expect.element("@modeCheckboxLabel").text.to.be.equal("Read-only");
    ...
    this.pivotContainer.section.modeToggle.assert.cssProperty("@modeCheckboxLabel", "background-color", "rgba(223, 56, 0, 1)");
  ...
  it("Check Using API calls mode toggle(interactive)", (client) => {
    ...
    this.pivotContainer.section.modeToggle.click("@modeCheckboxLabel");
    this.pivotContainer.section.modeToggle.expect.element("@modeCheckbox").to.be.selected;
    this.pivotContainer.section.modeToggle.expect.element("@modeCheckboxLabel").text.to.be.equal("Interactive");
    ...
    this.pivotContainer.section.modeToggle.assert.cssProperty("@modeCheckboxLabel", "background-color", "rgba(0, 164, 90, 1)");
