describe("testing Customizing Toolbar page", () => {
  ...
  it("Check 'Customizig the Toolbar' link to docs", (browser) => {
    this.pivotContainer.section.description.expect.element("@toCustomizingToolbarLink").to.be.visible;
    this.pivotContainer.section.description.expect.element("@toCustomizingToolbarLink").text.to.be.equal("Customizing the Toolbar");
    this.pivotContainer.section.description.expect
      .element("@toCustomizingToolbarLink")
  ...
  xit("Check New Tab on the Toolbar", (browser) => {
    this.pivotContainer.section.toolbar.section.leftGroup.expect.element("@newTab").to.be.visible;
    this.pivotContainer.section.toolbar.section.leftGroup.expect.element("@newTab").text.to.be.equal("New Tab");
    browser.waitForElementVisible("#fm-tab-newtab").click("#fm-tab-newtab a");
    ...
    this.pivotContainer.section.popup.expect
      .element("@popupLink")
      .to.have.attribute("href")
      .which.contains("https://www.flexmonster.com/doc/customizing-toolbar");
