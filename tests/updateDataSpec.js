describe("testing Update data page", () => {
  ...
  it("Add field to rows", () => {
    ...
    this.fieldListContent.section.hierarchiesList.expect.element("@colorFieldCaption").text.to.be.equal("Color");
  ...
  it("Add field to measures", () => {
    this.fieldListContent.section.hierarchiesList.expect.element("@discountFieldCaption").text.to.be.equal("Discount");
    ...
    this.fieldListContent.section.measuresList.expect.element("@discountMeasureCaption").text.to.be.equal("Sum of Discount");
  });
