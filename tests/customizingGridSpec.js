describe("testing Customizing Grid page", () => {
  ...
  it("Check 'Customizig the Grid' link to docs", () => {
    this.pivotContainer.section.description.expect.element("@toCustomizingGridLink").to.be.visible;
    this.pivotContainer.section.description.expect.element("@toCustomizingGridLink").text.to.be.equal("Customizing the grid cells");
    this.pivotContainer.section.description.expect
      .element("@toCustomizingGridLink")
  ...
  it("Check Customizing the grid Toggle (disable)", (client) => {
    ...
    this.pivotContainer.section.toggle.expect.element("@checkboxLabel").text.to.be.equal("The grid cells are not customized");
  ...
  it("Check Customizing the grid Toggle (enabled)", (client) => {
    ...
    browser.pause(1000);
    this.pivotContainer.section.toggle.expect.element("@checkbox").to.be.selected;
    this.pivotContainer.section.toggle.expect.element("@checkboxLabel").text.to.be.equal("The grid cells are customized");
  ...
  it("Add field to rows", () => {
    ...
    this.fieldListContent.section.hierarchiesList.expect.element("@businessTypeFieldCaption").text.to.be.equal("Business Type");
  ...
  it("Remove field from measures", () => {
    ...
    this.fieldListContent.section.measuresList.expect.element("@quantityMeasureCaption").text.to.be.equal("Sum of Quantity");
  ...
  it("Check measure header context menu", (client) => {
    ...
    this.contextMenu.expect.element("@contextMenuRow1").text.to.be.equal("Sort row ascending");
    this.contextMenu.expect.element("@contextMenuRow2").text.to.be.equal("Clear sorting");
    this.contextMenu.expect.element("@contextMenuRow3").text.to.be.equal("Aggregation");
    this.contextMenu.expect.element("@contextMenuRow4").text.to.be.equal("Number formatting");
    this.contextMenu.expect.element("@contextMenuRow5").text.to.be.equal("Conditional formatting");
    this.contextMenu.expect.element("@contextMenuRow6").text.to.be.equal("Remove measure");
  ...
  it("Add condition using context menu", (client) => {
    ...
    this.conditionalFormattingPopup.section.measuresDropdown.click("@measuresDropdownButton");
    this.conditionalFormattingPopup.section.measuresDropdown.expect.element("@measuresDropdownList").to.be.visible;
    this.conditionalFormattingPopup.section.measuresDropdown.assert.hasClass("@measuresDropdownListAll", "fm-selected");
    this.conditionalFormattingPopup.section.measuresDropdown.click("@measuresDropdownListDiscount");
    this.conditionalFormattingPopup.section.measuresDropdown.expect.element("@measuresDropdownButton").text.to.be.equal("Discount (Sum)");

    this.conditionalFormattingPopup.expect.section("@conditionsDropdown").to.be.visible;
    this.conditionalFormattingPopup.section.conditionsDropdown.click("@conditionsDropdownButton");
    this.conditionalFormattingPopup.section.conditionsDropdown.expect.element("@conditionsDropdownList").to.be.visible;
    this.conditionalFormattingPopup.section.conditionsDropdown.assert.hasClass("@conditionsDropdownListLessThan", "fm-selected");
    this.conditionalFormattingPopup.section.conditionsDropdown.click("@conditionsDropdownListGreaterThan");
