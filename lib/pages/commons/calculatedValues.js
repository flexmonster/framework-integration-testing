let testSuit = {
    ...
    runTestSuit: function () {
        ...
        describe("Check calculated values common part", () => {
            ...
            it('Changing aggregation', () => {
                ...
                fieldList.section.aggregationView
                    .assert.hasClass('@sumAggregation', 'fm-selected');
                fieldList.section.aggregationView
                    .assert.hasClass('@countAggregation', 'fm-not-selected');
