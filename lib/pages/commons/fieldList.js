let testSuit = {
  runTestSuit: function () {
    ...
    it("Adding field to rows", (client) => {
      ...
      fieldListContent.section.hierarchiesList.expect.element("@phoneFieldCaption").text.to.be.equal("Phone");
    ...
    it("Adding measure to values", () => {
      ...
      fieldListContent.section.hierarchiesList.expect.element("@quantityFieldCaption").text.to.be.equal("Quantity");
      ...
      fieldListContent.section.measuresList.expect.element("@quantityMeasure").text.to.be.equal("Sum of Quantity");
    });
    ...
    it("Opening the drop-down", (client) => {
      ...
      try {
        ...
        fieldListContent.section.hierarchiesList.expect.element("@locationFieldCaption").text.to.be.equal("Location");
        fieldListContent.section.hierarchiesList.click("@locationField");
        fieldListContent.section.hierarchiesList.expect.element("@cityFieldCaption").text.to.be.equal("City");
        fieldListContent.section.hierarchiesList.expect.element("@countryFieldCaption").text.to.be.equal("Country");
      } catch (e) {
        pivotGrid.expect.element("@configuratorButton").to.be.visible;
    ...
    it("Adding calculated value with formula", (client) => {
      ...
      calculatedValuesPopup.waitForElementVisible("@applyCalcValPopupButton").click("@applyCalcValPopupButton");
      client.waitForElementPresent("css selector", "li.fm-selected:nth-child(4)");
      fieldListContent.section.measuresList.expect.element("@formulaMeasureCaption").text.to.be.equal(calculatedFormulaName);
