let testSuit = {
    ...
    runTestSuit: function () {
        ...
        describe("Check the grid", () => {
            ...
            xit('Selection tooltip', (client) => {
                client.moveToElement('css selector', 'div[data-r="4"][data-c="1"]', 5, 5)
                    .mouseButtonDown('left')
                    .moveToElement('css selector', 'div[data-r="4"][data-c="2"]', 5, 5)
                    .mouseButtonUp('left');
            })
            ...
            it('Check number formatting performance', (client) => {
                ...
                contextMenu.click('@contextMenuRow3');
                this.expect.section('@numberFormattingPopup').to.be.visible;
                numberFormattingPopup.expect.element('@currencySymbolInput').value.to.be.equal('$');
                numberFormattingPopup.setValue('@currencySymbolInput', '#');
                numberFormattingPopup.expect.element('@currencySymbolInput').value.to.be.equal('#');
                client.moveToElement('css selector','#fm-btn-apply',5,5).click('#fm-btn-apply');
            ...
            it('Check license pop-up CTRL+ALT+I ', (client) => {
