let testSuit = {
  runTestSuit: function () {
    ...
    it("Check filters pop-up", (client) => {
      ...
      rowHeaders.waitForElementPresent("css selector", "div#fm-pivot-view div.fm-rows-filter div:nth-child(3) > div.fm-filter-header");
    ...
    xit("Check expands & collapses", (client) => {
      ...
      client.expect
        .element("div#fm-pivot-view div.fm-rows-sheet div.fm-scroll-content div:nth-child(2) > div.fm-header-r")
    ...
    it("Check number formatting performance", (client) => {
      ...
      contextMenu.click("@contextMenuRow3");
      this.expect.section("@numberFormattingPopup").to.be.visible;
      numberFormattingPopup.expect.element("@thousandsSeparatorLabel").text.to.be.equal("Thousands separator");
    ...
    it("Check Conditional formatting performance", (client) => {
      ...
      contextMenu.click("@contextMenuRow4");
      this.expect.section("@conditionalFormattingPopup").to.be.visible;
      conditionalFormattingPopup.click("@deleteSecondConditionButton");
    ...
    //client.keys now deprecated, they add keyUp&keyDown algorithm instead
    //but it doesn't want to work for 3 buttons pressed simultaneously
    xit("Check license pop-up CTRL+ALT+I ", (client) => {
      ...
      client
        .perform(function () {
          ...
          return actions.keyDown(client.Keys.CONTROL).keyUp(client.Keys.CONTROL).keyDown(client.Keys.ALT).keyUp(client.Keys.ALT);
        })
        .pause(6000);
