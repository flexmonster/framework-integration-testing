let testSuit = {
  runTestSuit: function () {
    ...
    it("Check 'Handling events' sidebar link", () => {
      sidebar.expect.element("@toHandlingEventsLink").to.have.attribute("href").which.contains("/handling-events");
    ...
    it("Check 'Using API calls' sidebar link", () => {
      sidebar.expect.element("@toUsingAPICallsLink").to.have.attribute("href").which.contains("/using-api-calls");
    ...
    it("Check 'Updating data' sidebar link", () => {
      sidebar.expect.element("@toUpdatingDataLink").to.have.attribute("href").which.contains("/updating-data");
    ...
    it("Check 'Customizing the Toolbar' sidebar link", () => {
      sidebar.expect.element("@toCustomizingToolbarLink").to.have.attribute("href").which.contains("/customizing-toolbar");
    ...
    it("Check 'Customizing the grid' sidebar link", () => {
      sidebar.expect.element("@toCustomizingGridLink").to.have.attribute("href").which.contains("/customizing-grid");
    ...
    it("Check 'With Highcharts' sidebar link", () => {
      sidebar.expect.element("@toHighchartsLink").to.have.attribute("href").which.contains("/with-highcharts");
    ...
    it("Check 'With amCharts' sidebar link", (client) => {
      sidebar.expect.element("@toAmChartsLink").to.have.attribute("href").which.contains("/with-amcharts");
