let testSuit = {
  runTestSuit: function () {
    ...
    it("Check options tab", () => {
      ...
      toolbarOptionsPopup.expect.element("@optionsTitle").text.to.be.equal("Layout options");
      toolbarOptionsPopup.expect.element("@optionsApplyButton").text.to.be.equal("APPLY");
      toolbarOptionsPopup.expect.element("@optionsCancelButton").text.to.be.equal("CANCEL");
    ...
    it("Check fields tab", () => {
      ...
      FieldList.expect.element("@fieldsCalculatedValueButton").text.to.be.equal("Add calculated value");
    ...
    it("Check fullscreen tab", (client) => {
      ...
      toolbar.click("@fullscreenTab").waitForElementVisible("css selector", "#fm-tab-fullscreen");
      client.pause(5);
      toolbar.expect.element("@fullscreenTab").to.be.visible;
  ...
  sections: {
    ...
    popup: {
      ...
      elements: {
        ...
        popupActionButton: "div.fm-content > div.fm-ui-btns-row > button.fm-ui-btn-dark",
        popupCancelButton: "div.fm-content > div.fm-ui-btns-row > button:not(.fm-ui-btn-dark)",
      },
    },
    FieldList: {
      ...
      elements: {
        ...
        fieldsCalculatedValueButton: "div.fm-popup-header > div.fm-ui-btns-row button.fm-btn-add-measure",
        fieldsApplyButton: "div.fm-popup-header > div.fm-ui-btns-row button.fm-ui-btn-dark",
        fieldsCancelButton: "div.fm-popup-header > div.fm-ui-btns-row button:not(.fm-btn-add-measure):not(.fm-ui-btn-dark)",
      },
    },
    pivotGrid: {
