    ...
    runTestSuit: function () {
        ...
        describe("Check navigation header", () => {
            ...
            it("Check navbar 'Integration with Vue2' link", () => {
                navbar.section.links.expect.element('@toVue2IntegrationLink').to.be.visible;
                navbar.section.links.expect.element('@toVue2IntegrationLink')
                    .to.have.attribute('href')
                    .which.contains('https://www.flexmonster.com/doc/integration-with-vue-2');
                navbar.section.links.expect.element('@toVue2IntegrationLink').text.to.be.equal("INTEGRATION WITH VUE 2");
