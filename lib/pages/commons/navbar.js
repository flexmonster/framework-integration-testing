let testSuit = {
  runTestSuit: function () {
    ...
    it("Check navbar 'Integration link", () => {
      navbar.section.links.expect.element("@toVueIntegrationLink").to.be.visible;
      navbar.section.links.expect
        .element("@toVueIntegrationLink")
        .to.have.attribute("href")
        .which.contains("https://www.flexmonster.com/doc/integration-with-");
      navbar.section.links.expect.element("@toVueIntegrationLink").text.to.contain("INTEGRATION WITH");
    });

    it("Check navbar 'Docs' link", () => {
      navbar.section.links.expect.element("@toDocsLink").to.be.visible;
      navbar.section.links.expect.element("@toDocsLink").to.have.attribute("href").which.contains("https://www.flexmonster.com/doc");
    ...
    it("Check navbar 'Help Center' link", () => {
      ...
      navbar.section.links.expect.element("@toHelpCenterLink").to.have.attribute("href").which.contains("https://www.flexmonster.com/help-center");
    ...
    it("Check navbar 'Contact us' link", () => {
      ...
      navbar.section.links.expect.element("@toContactLink").to.have.attribute("href").which.contains("https://www.flexmonster.com/contact");
